...
variable "zone"              { type = string  default = "europe-west3-a" }
variable "cluster_name"      { type = string  default = "kubeflow-min" }
variable "vpc_name"          { type = string  default = "kubeflow-vpc" }
